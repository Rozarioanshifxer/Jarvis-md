...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || ' ᴀɴsʜɪғ xᴇʀ; ᴀɴsʜɪғ xᴇʀ;https://graph.org/file/58ea74675af7836579a3a.jpg',
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_208a_a288_c530_760b_0b7b_c177_433d_71c1',
  ...
  CONTEXTINFO: process.env.CONTEXTINFO || `{"title": "ᴀɴsʜɪғ xᴇʀ", "body": "ᴀᴡᴇꜱᴏᴍᴇ 🍉", "thumbnailUrl": "https://i.imgur.com/OWJc4Qx.jpeg", "renderLargerThumbnail": true, "mediaType": 1, "mediaUrl": "", "sourceUrl": "https://github.com/Loki-Xer/Jarvis-md", "showAdAttribution": true}`,
  KOYEB_API: process.env.KOYEB_API,
  BRAINSHOP: process.env.BRAINSHOP || '172372,nbjE0YAlyw3cpoMl',
  TGTOKEN: "bot891038791:AAHWB1dQd-vi0IbH2NjKYUk-hqQ8rQuzPD4",
  API: 'https://api-loki-ser-1o2h.onrender.com/',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || ' ᴀɴsʜɪғ xᴇʀ;ᴡᴀʙᴏᴛ',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ; ᴀɴsʜɪғ xᴇʀ;https://graph.org/file/58ea74675af7836579a3a.jpg',
  ...
  BOT_INFO: process.env.BOT_INFO || ' ᴀɴsʜɪғ xᴇʀ;ᴀɴsʜɪғ xᴇʀ;https://graph.org/file/1506e5842805b0968c5cf.mp4',
